...
import importedCode from '@/../node_modules/@method-inc/utils/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @method-inc/utils
    ```
  </TabItem>
...
```tsx
import { ToggleGroupUtils } from '@method-inc/hooks';
...
```tsx
import { EmptyGestureResponderEvent } from '@method-inc/hooks';
import type { PressableRef, SlottablePressableProps } from '@method-inc/types';
