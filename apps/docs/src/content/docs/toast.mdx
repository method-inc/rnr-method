...
import importedCode from '@/../node_modules/@method-inc/toast/src/toast.tsx?raw';
import importedTypesCode from '@/../node_modules/@method-inc/toast/src/types.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @method-inc/toast
    ```
...
import { Portal } from '@method-inc/portal';
