...
import importedCode from '@/../node_modules/@method-inc/separator/src/separator.tsx?raw';
import importedTypesCode from '@/../node_modules/@method-inc/separator/src/types.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @method-inc/separator
    ```
